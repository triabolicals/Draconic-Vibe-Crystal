use unity::prelude::*;
use engage::{
    dialog::yesno::*, gamedata::Gamedata, mess::Mess,
    menu::{
        menus::config::ConfigMenu, BasicMenuResult, *,
        menu_item::config::{ConfigBasicMenuItem, ConfigBasicMenuItemCommandMethods},
    },
    pad::Pad, proc::Bindable,
    titlebar::TitleBar, 
    util::get_instance
};
use crate::{
    config::menu::create_dvc_bind, ironman::vtable_edit,
    deployment, continuous, randomizer, get_nested_il2cpp_class,
    utils::get_nested_class,
    menus::ingame::draconic_vibe_name
};
pub mod ingame;
...
impl ConfigBasicMenuItemCommandMethods for TriabolicalMenu {
    ...
    extern "C" fn set_command_text(this: &mut ConfigBasicMenuItem, _method_info: OptionalMethod) { 
        this.command_text = "All will be Revealed".into(); 
    }
    extern "C" fn set_help_text(this: &mut ConfigBasicMenuItem, _method_info: OptionalMethod) { 
        this.help_text = "Open up the Draconic Vibe Crystal settings.".into(); 
    }
...
pub fn my_b_call(_this: &ConfigMenu<()>, _: OptionalMethod) -> BasicMenuResult {
