...
pub fn job_gauge_build_attr(_this: &mut ConfigBasicMenuItem, _method_info: OptionalMethod) -> BasicMenuItemAttribute  {
...
pub fn skill_gauge_build_attr(_this: &mut ConfigBasicMenuItem,  _method_info: OptionalMethod) -> BasicMenuItemAttribute  {
...
pub fn hub_item_build_attr(_this: &mut ConfigBasicMenuItem,  _method_info: OptionalMethod) -> BasicMenuItemAttribute  {
    if DVCVariables::is_main_menu() { BasicMenuItemAttribute::Enable }
    else if GameVariableManager::get_number(DVCVariables::ITEM_KEY) != 0 && GameUserData::get_sequence() != 5 { BasicMenuItemAttribute::Enable }
    else { BasicMenuItemAttribute::Hide }
}
pub fn not_in_map_sortie_build_attr(_this: &mut ConfigBasicMenuItem,  _method_info: OptionalMethod) -> BasicMenuItemAttribute  {
    if DVCVariables::is_main_menu() {BasicMenuItemAttribute::Enable  }
...
pub fn not_in_map_build_attr(_this: &mut ConfigBasicMenuItem,  _method_info: OptionalMethod) -> BasicMenuItemAttribute  {
    if DVCVariables::is_main_menu() {BasicMenuItemAttribute::Enable  }
...
pub fn dlc_build_attr(_this: &mut ConfigBasicMenuItem,  _method_info: OptionalMethod) -> BasicMenuItemAttribute  {
