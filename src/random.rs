...
pub fn write_seed_output_file() {
    ...
    if GameVariableManager::get_number("G_InteractSetting") != 0 {
        ...
        let interact_list = crate::grow::InteractData::get_list().unwrap();
        for x in 1..10 {
...
pub fn reset_gamedata() {
    ...
    ItemData::unload();
    ItemData::load_data();
    crate::grow::InteractData::unload();
    crate::grow::InteractData::load_data();
    ...
    *CONFIG.lock().unwrap() = DeploymentConfig::new();
    ...
    unsafe {
        if GameVariableManager::get_number("G_Random_Seed") != CURRENT_SEED  {
            ...
            randomize_engage_links();
            item::randomize_well_rewards();
            crate::grow::change_interaction_data( GameVariableManager::get_number("G_InteractSetting") );
            write_seed_output_file();
